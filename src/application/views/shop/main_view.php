<!-- ARQUIVO 3: loja.php (padronizado) -->
<!DOCTYPE html>
<html lang="pt-BR">
<head>
    <meta charset="UTF-8">
...
<body>
<div class="container mt-5" x-data="shop(<?php echo htmlspecialchars(json_encode($cart ?? ['items' => [], 'subtotal' => 0, 'discount' => 0, 'shipping_cost' => 0, 'total' => 0]), ENT_QUOTES, 'UTF-8'); ?>)">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h2>Loja</h2>
        <a href="<?php echo site_url('management'); ?>" class="btn btn-info">Área de Gerenciamento</a>
    </div>
    <hr>
            ...
            <div class="col-md-4">
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <button class="btn btn-success" @click="addToCart(<?php echo $product->id; ?>)" :disabled="productLoading === <?php echo $product->id; ?> || <?php echo $product->quantity <= 0 ? 'true' : 'false'; ?>">
        ...
        <div>
            ...
            <div class="text-right">
                ...
                <template x-if="cart.discount > 0">
                    <p class="text-success"><strong>Desconto:</strong> - R$ <span x-text="formatCurrency(cart.discount)"></span></p>
                </template>
            ...
            <form @submit.prevent="applyCoupon" class="form-inline my-4">
                <input type="text" class="form-control mr-2" x-model="couponCode" placeholder="Cupom de desconto" :disabled="loading">
